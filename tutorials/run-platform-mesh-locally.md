...
- [Troubleshoot local setup](/how-to-guides/troubleshoot-local-setup.md) if anything failed above.
- [Why Platform Mesh?](/concepts/why-platform-mesh.md) for the motivation.
- [Architecture](/concepts/architecture.md) for the runtime component layout.
